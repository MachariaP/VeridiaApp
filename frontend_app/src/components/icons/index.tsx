/**
 * VeridiaApp Icon System
 * SVG icons with consistent styling and accessibility
...
// Action Icons
export function ThumbsUpIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ThumbsDownIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MessageIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BookmarkIcon({ size = 24, className = '', filled, ...props }: IconProps & { filled?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
...
export function AlertCircleIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HeartIcon({ size = 24, className = '', filled, ...props }: IconProps & { filled?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
